...
private:
	...
	void initBoundingBox(VECTOR3 &left_lower_rear, VECTOR3 &right_top_front)
	{
		...
		Olog::assertThat([this]() { return left <= right; }, "Left side of bounding box must be smaller than right side!");
		Olog::assertThat([this]() { return bottom <= top; }, "Bottom side of bounding box must be smaller than top side!");
		Olog::assertThat([this]() { return rear <= front; }, "Rear side of bounding box must be smaller than Front side!");
