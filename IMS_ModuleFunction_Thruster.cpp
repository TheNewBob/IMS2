...
{
	Olog::assertThat([modeidx, this]() { return modeidx < data->getNumberOfModes(); }, "Thrustermode index out of bounds!");
...
void IMS_ModuleFunction_Thruster::SetThrusterGroup(int thrustergroup)
{
	...
	Olog::assertThat([thrustergroup]() { return (thrustergroup >= -1 && thrustergroup <= (int)THGROUP_HOVER) ||
