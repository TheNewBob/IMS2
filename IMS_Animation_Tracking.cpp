...
IMS_Animation_Tracking::IMS_Animation_Tracking(ANIMATIONDATA *_data) : IMS_Animation_Base(_data)
{
}
...
bool IMS_Animation_Tracking::propagateState(double &_state, double _targetstate, double _speed, double simdt, bool canloop)
{
...
void IMS_Animation_Tracking::calculateTargetState()
{
...
int IMS_Animation_Tracking::determineMovementDirection(double targetstate, double currentstate, bool canloop)
{
