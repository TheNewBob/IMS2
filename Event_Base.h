 ...
 * events should have a unique identifier which you should add to the enum in events.h,
...
public:
	 ...
	 * Events that carry information might need more distinction!
	...
	*/
	 ...
	 *
	 * This is the event pipe the event is travelling in,
...
protected:
	...
	/**
	 * \brief Used to determine whether the event should be sent by the event generator.
	 *
